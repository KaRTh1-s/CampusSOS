...
| **Phase 6** | **Amazon Bedrock AI Integration** | **NEXT (Part 6)** | Real-time Bedrock invocation with Amazon Nova / Titan in `ap-south-1`. System prompt engineering for classification, priority, safety actions, and strict JSON output. |
